...
public class UtilPropOnstead {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "E:\\IntroSoftware\\workspace4830\\workspace4830-TechExercise-Onstead\\Project-LibraryOfBooks\\WebContent\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat9/webapps/Project-LibraryOfBooks/config.properties";
